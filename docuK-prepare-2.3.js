...
(function (m, $, undefined) {
    ...
    m.getSearchVars = function (searchStr) {
        ...
        if (searchStr !== null && searchStr !== undefined && searchStr.length) {
            ...
            for (let i = 0; i < splits.length; i++) {
                ...
                vars[m.symArray][i] = vars[key] = { key: key, val: value };
            }
        }
        return vars;
    };
    ...
    m.rC = function (elemStr, option, id, noPc) {
        return `<div class="rC${option ? ` ${option}` : ""}"${!!id ? ` id="${id}"` : ""}><div class="rSC">${elemStr}</div>${noPc
            ? ""
            : `<div class="pc"><span onclick="k.togglePosition(this)">▲ [--stick to the left top--]</span></div>`}</div>`;
    };
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (exec !== null) {
                ...
                if (v) {
                    return resolve({
                        html: (toA
                            ? `<a target="_blank" href="https://www.youtube.com/watch?v=${v}${config.start ? `&start=${config.start}` : ""}${config.end ? `&end=${config.end}` : ""}${list ? `&list=${list}` : ""}">https://www.youtube.com/watch?v=${v}${config.start ? `&start=${config.start}` : ""}${config.end ? `&end=${config.end}` : ""}${list ? `&list=${list}` : ""}</a><br/>`
            ...
            if (exec !== null) {
                return resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<iframe delayed-src="https://docs.google.com/spreadsheets/d/e/${exec[1]}/pubhtml?widget=true&headers=false"></iframe>`),
                    from: "docs-google",
                    docId: exec[1],
                });
            }
            ...
            if (exec !== null) {
                resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<div class="center"><iframe delayed-src="https://www.instagram.com/p/${exec[1]}/embed" allowtransparency="true"></iframe></div>`, "instagram", null, true),
                    from: "instagram",
                    imgId: exec[1],
                });
            }
            ...
            if (exec !== null) {
                resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<div class="center"><iframe delayed-src="https://imgur.com/a/${exec[1]}/embed?pub=true&context=false" allowtransparency="true"></iframe></div>`, "imgur", null, true),
                    from: "imgur",
                    imgId: exec[1],
                });
            }
            ...
            if (exec !== null) {
                resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<div class="center"><iframe sandbox="allow-popups allow-popups-to-escape-sandbox allow-scripts allow-top-navigation allow-same-origin" delayed-src="https://www.tiktok.com/embed/v2/${exec[2]}?referrer=${encodeURIComponent(window.location.host)}"></iframe></div>`, "tiktok", null, true),
                    from: "tiktok",
                    userId: exec[1],
                    videoId: exec[2],
                });
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (exec !== null) {
                ...
                $.ajax({
                    ...
                    let decomposedURI = m.decomposeURI(resp);
                    if (decomposedURI.uriHost === "www.tiktok.com") {
                        let uriRendered = await m.uriRendering(resp, toA, inListPlay);
            ...
            if (exec !== null) {
                resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<iframe delayed-src="https://serviceapi.rmcnmv.naver.com/${exec[0]}" marginwidth="0" marginheight="0" allowfullscreen></iframe>`, inListPlay && m.fsToRs.fixed ? "fixed" : null),
                    from: "naver",
                    videoId: exec[0],
                });
            }
            ...
            if (exec !== null) {
                resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<iframe delayed-src="https://tv.naver.com/embed/${exec[1]}?autoPlay=false" marginwidth="0" marginheight="0" allowfullscreen></iframe>`, inListPlay && m.fsToRs.fixed ? "fixed" : null),
                    from: "naver",
                    videoId: exec[1],
                });
            }
            ...
            if (exec !== null) {
                resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<iframe src="https://weverse.io/${exec[1]}/artist/${exec[2]}" marginwidth="0" marginheight="0" allowfullscreen></iframe>`, inListPlay && m.fsToRs.fixed ? "fixed" : null),
                    from: "weverse",
                    singer: exec[1],
                    videoId: exec[2],
                });
            ...
            if (exec !== null) {
                return resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<iframe delayed-src="https://play-tv.kakao.com/embed/player/cliplink/${exec[1]}" allowfullscreen></iframe>`, inListPlay && m.fsToRs.fixed ? "fixed" : null),
                    from: "kakao",
                    videoId: exec[1],
                });
            }
            ...
            if (exec !== null) {
                return resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<iframe delayed-src="https://videofarm.daum.net/controller/video/viewer/Video.html?vid=${exec[1]}${exec[1].length < 15 ? "$" : ""}&play_loc=undefined"></iframe>`, inListPlay && m.fsToRs.fixed ? "fixed" : null),
                    from: "daum",
                    videoId: exec[1],
                });
            }
            ...
            if (exec !== null) {
                resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<iframe delayed-src="https://player.vimeo.com/video/${exec[1]}" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>`, inListPlay && m.fsToRs.fixed ? "fixed" : null),
                    from: "vimeo",
                    videoId: exec[1],
                });
            }
            ...
            if (exec !== null) {
                resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<iframe delayed-src="https://www.dailymotion.com/embed/video/${exec[1]}" allowfullscreen></iframe>`, inListPlay && m.fsToRs.fixed ? "fixed" : null),
                    from: "dailymotion",
                    videoId: exec[1],
                });
            }
            ...
            if (exec !== null) {
                ...
                resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<iframe delayed-src="https://embed.ted.com/talks/${uriRest}" allowfullscreen></iframe>`, inListPlay && m.fsToRs.fixed ? "fixed" : null),
                    from: "ted",
                    videoId: v,
                });
            }
            ...
            if (exec !== null) {
                ...
                return resolve({
                    html: (toA
                        ...
                        : "") +
                        m.rC(`<iframe delayed-src="https://w.soundcloud.com/${lastPath.substring(0, lastPath.length - 1)}"></iframe>`, inListPlay && m.fsToRs.fixed ? "fixed soundcloud" : "soundcloud"),
                    from: "soundcloud",
                ...
                if (v) {
                    return resolve({
                        html: (toA
                            ...
                            : "") +
                            m.rC(`<iframe delayed-src="https://gall.dcinside.com/board/movie/share_movie?no=${v}"></iframe>`, inListPlay && m.fsToRs.fixed ? "fixed" : ""),
                        from: "dcinside",
                        videoId: v,
                    });
                }
                    ...
                    if (no) {
                        return resolve({
                            html: (toA
                                ...
                                : "") +
                                m.rC(`<iframe src="https://gall.dcinside.com/board/poll/vote?no=${no}"></iframe>`),
                            from: "dcinside",
                            voteId: no,
                        });
                    }
                ...
                if (v) {
                    return resolve({
                        html: (toA
                            ...
                            : "") +
                            m.rC(`<iframe delayed-src="https://v.qq.com/txp/iframe/player.html?vid=${v}"></iframe>`, inListPlay && m.fsToRs.fixed ? "fixed" : ""),
                        from: "qq",
                        videoId: v,
    ...
    ptnURI.toIframe = function (uri, inListPlay, toA) {
        return new Promise(function (resolve, reject) {
            ...
            if (exec !== null) {
                resolve({
                    html: (toA
                        ? `<a target="_blank" href="${exec[1]}">${m.escapeOnlyTag(decodeURIComponent(uri))}</a><br/>`
    ...
    ptnURI.toIframe = function (uri, inListPlay, toA, descR) {
        return new Promise(function (resolve, reject) {
            ...
            if (exec !== null) {
                return resolve({
                    html: (toA
                        ? `<a target="_blank" href="${exec[0]}${config.hash ? config.hash : ""}">${m.escapeOnlyTag(decodeURIComponent(`${uri}${config.hash ? config.hash : ""}`))}</a><br/>`
                        : "") +
                        m.rC(`<video controls preload="metadata" delayed-src="${exec[0]}${config.hash ? config.hash : ""}"></video>`, inListPlay && m.fsToRs.fixed ? "fixed" : null),
                    from: "video",
                    src: exec[0],
                    config,
                });
    ...
    ptnURI.toIframe = function (uri, inListPlay, toA) {
        return new Promise(function (resolve, reject) {
            ...
            if (exec !== null) {
                ...
                return resolve({
                    html: `<a target="_blank" href="${href}">${m.escapeOnlyTag(decodeURIComponent(uri))}</a>` +
                        m.rC(`<div class="center"><img delayed-src="${href}"/></div>`, inListPlay && m.fsToRs.fixed ? "fixed eveElse" : "eveElse"),
                    from: "file-image",
                    src: href,
                });
            }
                ...
                if (exec !== null) {
                    ...
                    uri = uri.replace(/\+/g, "%20").replace(/%2B/g, "%20");
                    return resolve({
                        html: `<a target="_blank" href="${href}">${m.escapeOnlyTag(decodeURIComponent(uri))}</a><br/>` +
                            m.rC(`<video controls preload="metadata" delayed-src="${href}"></video>`, inListPlay && m.fsToRs.fixed ? "fixed" : null),
                        from: "file-video",
                        src: href,
                    });
                }
                    ...
                    if (exec !== null) {
                        ...
                        return resolve({
                            html: `<a target="_blank" href="${href}">${m.escapeOnlyTag(decodeURIComponent(uri))}</a><br/>` +
                                m.rC(`<iframe delayed-src="${href}"></iframe>`, inListPlay && m.fsToRs.fixed ? "fixed" : null),
                            from: "file-pdf",
                            src: href,
                        });
                    }
        ...
        return new Promise(async function (resolve, reject) {
            if (uri && uri.constructor === String) {
                ...
                if (!keepOriginal && m.getUTF8Length(uri) > 255) {
                    return m
                        .getConciseURI(uri)
                        .then((conciseURI) => resolve(m.unescapeHTML(conciseURI)));
                }
    ...
    m.uriRendering = function (uri, toA, inListPlay, descR) {
        return new Promise(async function (resolve, reject) {
            uri = uri.trim();
            let decomposedURI;
            let result;
            ...
            if (uriHost) {
                ...
                for (let i = 0; i < m.ptnURI[m.symArray].length; i += 1) {
                    try {
                        result = await m.ptnURI[m.symArray][i]?.toIframe(uri, inListPlay, toA, descR);
                        if (Boolean(result)) {
    ...
    m.relatedRendering = function (str) {
        return new Promise(async function (resolve, reject) {
            if (!str || typeof str !== "string") {
                return resolve("");
            }
...
<a id="out-focus" class="none">out focus</a>`);
        ...
        for (let i = 1; i < sorted.length; i++) {
            ...
            for (; j > 0 &&
                fs.array[0].array[sorted[j - 1]].maxMatchScore <
                    fs.array[0].array[temp].maxMatchScore; j--) {
                sorted[j] = sorted[j - 1];
            }
            sorted[j] = temp;
        }
    ...
    window.$fuzzy_search.on("keydown.fs-move-exit", function (e) {
        e.stopPropagation();
        switch (e.code) {
            case "Escape": // ESC=27
                e.preventDefault();
            ...
            case "ArrowDown": // down=40
                ...
                if ($liSelected.length) {
                    ...
                    if ($liTo.length) {
                        ...
                        else if ($liTo.offset().top + $liTo.outerHeight() >
                            $fsl.offset().top + $fsl.height() + 2) {
                            // $liTo at downside of scroll.
                            $fsl.scrollTop($fsl.scrollTop() +
                                $liTo.offset().top +
                                $liTo.outerHeight() -
                                $fsl.offset().top -
                                $fsl.height() -
    ...
    m.doFSGo = function (fs) {
        ...
        if (fs.array[0].ptnSH.splitted !== fsPtnSH.splitted) {
            ...
            for (let i = 0; i < sorted.length; i++) {
                ...
                str += `<div class="list-item" onclick="k.gotoLi(event,this,${k},m.fsGo)">${fsFLk.html}${res[sorted[i]].highlight !== undefined
    ...
    m.fsGoOn = function () {
        ...
        if (passed > m.wait) {
            ...
            window.$fuzzy_search.off("keyup.fs cut.fs paste.fs");
            setTimeout(function () {
                window.$fuzzy_search.on("keyup.fs cut.fs paste.fs", m.fsGoOn);
                m.previous = Date.now();
                m.doFSGo(m.fsGo);
            }, m.wait * 1.5 - passed);
        }
    ...
    m.strToJSON = function (str, colMap = true, rowMap = false) {
        ...
        if (colMap) {
            ...
            for (let i = 0; i < ret[m.symArray].length; i++) {
                let jMax = ret[m.symArray][i].length > firstColSize
                    ? firstColSize
    ...
    m.csvToJSON = function (str, colMap = true, rowMap = false) {
        ...
        if (colMap) {
            ...
            for (let i = 0; i < rows[m.symArray].length; i++) {
                let jMax = rows[m.symArray][i].length > firstColSize
                    ? firstColSize
    ...
    m.renderToDocuK = function (toBeRendered, docuKI) {
    ...
    m.printDeviceInfo = function () {
        if (m.$deviceInfo) {
            ...
            let referrerHTML = referrer
                ? `<a target="_blank" href="${referrer}">${m.escapeOnlyTag(decodeURIComponent(referrer))}</a>`
                : `Empty`;
            m.$deviceInfo.html(`Mode: ${m.mode}; Font: ${m.fontFamily}; font-size: ${(m.fontSize * 1.8).toFixed(1)}px (${m.fontSize.toFixed(1)}); line-height: ${(m.lineHeight10 / 10).toFixed(1)};<br/>
width: ${m.browserWidth}, height: ${window.innerHeight}, version: ${m.version0}${m.version1}<br/>
${m.canonicalURI
                ? `Canonical URI: <a target="_blank" href="${m.canonicalURI}">${m.escapeOnlyTag(decodeURIComponent(m.canonicalURI))}</a><br/>`
                : ""}
${m.plink
...
✖
            ...
            if (m.$delayedElems.length > 0) {
                m.$delayedElems.each(function () {
                    if ($(this).delayedLoad()) {
                        ...
                        m.logPrint(`<br/><span class="emph">${this} at vertical position of ${((100.0 * $(this).offset().top) /
                            m.$document.height()).toPrecision(3)}% of document is delayed-loaded.</span><br/>${m.$delayedElems.length} of $delayedElems are remained.<br/>`);
                    }
                });
    ...
    // docuK Process
    m.docuKProcess = function docuK(m, docuKI) {
        ...
        const $docuKI = m.$docuK.eq(docuKI);
        ...
        if ($docuKI.is(".noDIdHandle") || docuKI <= 1) {
            ...
            $docuKI.find("[id]").each((index, element) => {
                const $this = this;
...
<div class="SNS-top"><img class="SNS-img" src="https://tistory1.daumcdn.net/tistory/1468360/skin/images/link.png" onclick="return m.shareSNS('link')"><img class="SNS-img" src="https://tistory1.daumcdn.net/tistory/1468360/skin/images/icon-Tag.png" onclick="return m.shareSNS('tag')"><img class="SNS-img" src="https://tistory1.daumcdn.net/tistory/1468360/skin/images/icon-Recoeve.png" onclick="k.shareSNS('recoeve')"><img class="SNS-img" src="https://tistory1.daumcdn.net/tistory/1468360/skin/images/icon-X.png" onclick="k.shareSNS('X')"><img class="SNS-img" src="https://tistory1.daumcdn.net/tistory/1468360/skin/images/icon-Facebook.png" onclick="k.shareSNS('facebook')"><img class="SNS-img" src="https://tistory1.daumcdn.net/tistory/1468360/skin/images/icon-Kakao.png" onclick="k.shareSNS('kakao')"><img class="SNS-img" src="https://tistory1.daumcdn.net/tistory/1468360/skin/images/icon-Whatsapp.png" onclick="k.shareSNS('Whatsapp')"></div>`);
        ...
        let $olRefs = $docuKI.find("ol.refs");
        $olRefs = $olRefs.eq($olRefs.length - 1);
        let $refs = $docuKI.find("ol.refs>li");
        let refsN = $refs.length;
        for (let i = 0; i < refsN; i++) {
            // ref [i+1] with id
            $refs
                .eq(i)
                .prepend(`<span class="refN">Ref. <span class="number">[${pad((i + 1).toString(), 2)}]</span> </span>`);
        }
        let $cites = $docuKI.find("cite"), $citeI, $refered;
        ...
        let $refers = $docuKI.find("refer"), $referI;
