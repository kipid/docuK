import type { DecomposedURI, DescR, FSToRs, FuzzySearch, FuzzySearchResult, PatternURI, RenderResult, SearchVars, SplitHangul, StrToJSON, YTiframeConfig, YTiframeResult } from "./types/types";
