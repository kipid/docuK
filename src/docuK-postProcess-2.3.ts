...
svg: {
	fontCache: 'global'
		...
		$("pre").each((i: number, elem: HTMLElement) => {
			const $elem: JQuery<HTMLElement> = $(elem);
			if ($elem.children("code").length === 0) {
